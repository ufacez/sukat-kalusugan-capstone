...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    /*
     * GET THE PARENT'S BARANGAY
     *
     * The nutritionist does NOT submit barangay_id.
     * The child's barangay_id always comes from the selected parent.
     */
     ...
     * UPDATE CHILD
     *
     * Barangay is automatically updated from the selected parent.
     */
...
if ($deleteId > 0) {
    admin_redirect(
        '/nutritionist/children.php?edit=' . $deleteId . '#child-form'
    );
}
                        ...
                        <td>
                            ...
                            <div class="admin-actions">
                                ...
                                <a
                                    ...
                                    href="<?php echo nutritionist_e(
                                        app_url(
                                            '/nutritionist/children.php?edit='
                                            . (int)$child['id']
                                        )
                                        . '#child-form'
                                    ); ?>"
...
>
    ...
    >
        ...
        <!--
            BARANGAY IS NOT SELECTED HERE.

            It is automatically inherited from the
