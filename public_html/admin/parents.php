                    ...
                    <tr data-filter-text="<?php echo admin_e(strtolower($parent['name'] . ' ' . $parent['email'] . ' ' . (string)($parent['address'] ?? '') . ' ' . (string)($parent['phone'] ?? ''))); ?>">
                        ...
                        <td>
                            ...
                            <div class="admin-actions">
                                ...
                                <form method="post" action="<?php echo admin_e(app_url('/api/admin/parents_archive.php')); ?>" data-admin-confirm="Archive <?php echo admin_e($parent['name']); ?>?" style="display:inline;">
