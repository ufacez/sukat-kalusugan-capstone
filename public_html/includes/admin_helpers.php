...
function admin_action_icon(string $key): string
{
    $icons = [
        ...
        'funnel'    => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3 4.5h18M5.25 9.75h13.5m-10.5 5.25h7.5"/></svg>',
        'calendar'  => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5"/></svg>',
        ...
        'lightbulb' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 18v-5.25m0 0a6 6 0 0 0 1.5-.189m-1.5.189a6 6 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.354a15.06 15.06 0 0 1-3 0M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-4.773-4.227-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636"/></svg>',
        'trend_up'    => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941"/></svg>',
        ...
        'file_xls'  => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M9 4.5v15m6-15v15m-10.875 0h15.75c.621 0 1.125-.504 1.125-1.125V5.625c0-.621-.504-1.125-1.125-1.125H4.125A1.125 1.125 0 0 0 3 5.625v12.75c0 .621.504 1.125 1.125 1.125Z"/></svg>',
        'file_csv'  => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z"/></svg>',
        'file_pdf'  => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Zm3.75 11.625-3 3m0 0-3-3m3 3V8.25"/></svg>',
    ];
...
function admin_layout_start(string $title, string $subtitle, string $activeSection, string $actionsHtml = '', ?string $breadcrumbExtra = null): void
{
    ...
    $breadcrumb = admin_build_breadcrumb($activeSection, admin_grouped_nav_items(), $breadcrumbExtra);
    ...
    if ($hasGroup) {
        echo '<span class="admin-breadcrumb-group">' . admin_e($breadcrumb['group']) . '</span>';
        echo '<span class="admin-breadcrumb-sep" aria-hidden="true">&#8250;</span>';
    }
    if ($hasExtra) {
        echo '<span class="admin-breadcrumb-page">' . admin_e($breadcrumb['page']) . '</span>';
        echo '<span class="admin-breadcrumb-sep" aria-hidden="true">&#8250;</span>';
        echo '<span class="admin-breadcrumb-page is-active">' . admin_e($breadcrumb['extra']) . '</span>';
    } else {
        echo '<span class="admin-breadcrumb-page is-active">' . admin_e($breadcrumb['page']) . '</span>';
    }
    echo '</nav>';
    echo '</div>';
    ...
    echo '<span class="admin-topbar-name">' . admin_e($userName) . '</span>';
    echo '<span class="admin-topbar-role">' . admin_e(ucfirst($userRole)) . '</span>';
    echo '</div>';
    echo '</div>';
    echo '</div>';
    echo '</header>';
